...
<head>
    ...
    <title>噼里啪啦-注册</title>
    <link href="<%=request.getContextPath()%>/static/register/css/jq22.css" rel="stylesheet" type="text/css" />
    <script src="http://www.jq22.com/jquery/jquery-1.10.2.js"></script>
    <script language='javascript' src="<%=request.getContextPath()%>/static/register/js/jq22.js"></script>
</head>
...
<div class='body_main'>
    ...
    <div class='index_box' style='margin-top: 20px;'>
        ...
        <div class='box_title'><div class='text_content'></div>
        </div>
        <!-- 注册From 表单 -->
        <div class='box_main'>
            <div id="register" class="register">
                <form id="form" action="<%=request.getContextPath()%>/register.do2" method="post"
                      onSubmit="return check();">
                    <label style="font-size: 24px">注册</label>
                                ...
                                <span class="control-group" id="username_input">
										<div class="input_add_long_background">
											<input class="register_input" type="text" id=""
                                                   name="userNickName" maxLength="50" onblur="">
										</div>
									</span><font color="red">${register_mes}</font> <label class="tips">请输入您用作本网站登录的账号</label>
                            </div>


                            <div class="field-group" style="margin-bottom: 100px">
                    ...
                    <%--<div style="color: red" align="center">验证码:${code}
                    ...
                    <div  class="">
                        <div class='div_submit_button'>
                            ...
                            <a href="<%=request.getContextPath()%>/web-jsp/login.jsp">返回登录?</a>
                        </div>
                    </div>
                </form>
            </div>
