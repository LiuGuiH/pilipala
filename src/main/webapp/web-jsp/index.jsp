            ...
            <div class="page-width clearfix">
                <div class="header-top__nav">
                    <ul>
                        ...
                        <li class="item"><a href="${pageContext.request.contextPath}/web-jsp/videoFileTop.jsp">我要投稿</a>
                ...
                <div class="header-top__user">
                    ...
                    %>
                    <div class="login-box">
                        <a href="<%=request.getContextPath()%>/web-jsp/login.jsp">登录</a> <span></span> <a href="<%=request.getContextPath()%>/web-jsp/register.jsp">注册</a>
                            <input style="border-style: solid;" type="text" name="sousuo1" id="sousuo1"/>
                            <a href="sousuo.do">搜索</a>
                    </div>
                    ...
                    <div onmouseover="project()">
                        <span style="color: white;">欢迎你的登录: &nbsp; &nbsp; &nbsp;<%=((User)request.getSession().getAttribute("user")).getName() %></span>
                        &nbsp;&nbsp;&nbsp;
                    </div>
                    <%} %>
                </div>
                <div class="header-top__user"
                    ...
                    <div>
                        <br> <a href="<%=request.getContextPath()%>/showUserInfo.do2" style="color: red">个人信息</a>&nbsp;&nbsp;<a
                            href="<%=request.getContextPath()%>/web-jsp/modifyPassword.jsp" style="color: red">修改密码</a>&nbsp;&nbsp;<a
                            href="<%=request.getContextPath()%>/web-jsp/insert_user_info.jsp" style="color: red">修改信息</a><br>
                        <div style="background-color: black">------------------------</div>
                        <br> <a href="<%=request.getContextPath()%>/exitLogin.do2" style="margin-left: 23%">切换用户</a>
                    </div>
        ...
        <div class="banner-list fr">
            <ul>
                <c:forEach items="${fuck}" var="fuck">
                    <li><a href="video.do?dizhi=${fuck.videoAddress}&shipingID=${fuck.videoID}">
            ...
            <div class="pic-list fl" js-tab="true">
                ...
                <ul class="pic-list__wrapper clearfix tab-cont__item tab-cont__cur">
                    ...
                    <c:forEach items="${list}" var="list">
                        <li class="item"><a
                                href="video.do?dizhi=${list.videoAddress}&shipingID=${list.videoID}"
                                class="img-link"> <img
                            ...
                            <div class="img-info">
                                <a
                                        href="video.do?dizhi=${list.videoAddress}&shipingID=${list.videoID}">${list.videoName }</a>
                                <div class="btm">
                                    <div class="user">
                                        <i></i>admin
                                    </div>
                ...
                <div class="main-side__cont">
                    <div class="tab-cont">
                        <ul class="tab-cont__item main-rank" id="did2">
                            <li class="item"><a href="video.do?dizhi=/static/videolook/weileshenmebianqiang.mp4&amp;shipingID=33"><i class="n2">1</i> 【ASMV综漫燃向】为了什么而战，为了变强，能保护你那么强</a></li>
                            <li class="item"><a href="video.do?dizhi=/static/videolook/7190132-1-hd.mp4&amp;shipingID=14"><i class="n2">2</i>【LL】老司机带带我</a></li>
                            <li class="item"><a href="video.do?dizhi=/static/videolook/gaobaiqiqiu.mp4&amp;shipingID=28"><i class="n2">3</i>【全明星】告白气球-1.【全明星】告白气球</a></li>
                            <li class="item"><a href="video.do?dizhi=/static/videolook/3617382hd.mp4&amp;shipingID=7"><i class="n2">4</i>未闻花名 secret base MAD</a></li>
                            <li class="item"><a href="video.do?dizhi=/static/videolook/7015300-1-hd.mp4&amp;shipingID=13"><i class="n2">5</i>【AMV】 好想大声说出来 ！！！</a></li>
                            <li class="item"><a href="video.do?dizhi=/static/videolook/8980857-1-hd.mp4&amp;shipingID=15"><i class="n2">6</i>【Re：从零开始的异世界生活/MAD】 傲慢与怠惰！！</a></li>
                            <li class="item"><a href="video.do?dizhi=/static/videolook/sheqiyiqie.mp4&amp;shipingID=39"><i class="n2">7</i> 【AMV治愈向春物】若能舍弃一切的话</a></li>
                        </ul>
                    </div>
            ...
            <div class="pic-list fl" js-tab="true">
                ...
                <ul class="pic-list__wrapper clearfix tab-cont__item tab-cont__cur">
                    ...
                    <c:forEach items="${list2}" var="list2">
                        <li class="item"><a
                                href="video.do?dizhi=${list2.videoAddress}&shipingID=${list2.videoID}"
                                class="img-link"> <img
                            ...
                            <div class="img-info">
                                <a
                                        href="video.do?dizhi=${list2.videoAddress}&shipingID=${list2.videoID}">${list2.videoName }</a>
                                <div class="btm">
                                    <div class="user">
                                        <i></i>admin
                                    </div>
